...
export class AppConstants {
    ...
    private static populateThirdFloor() {
        let point1: Room = new Room(0.143, 0.772, '303', 2);
        let point2: Room = new Room(0.119, 0.802, '302', 2);
        let point3: Room = new Room(0.108, 0.838, '301', 2);
        let point4: Room = new Room(0.168, 0.820, '', 2);
        let point5: Room = new Room(0.216, 0.859, '325', 2);
        let point6: Room = new Room(0.244, 0.825, '', 2);
        let point7: Room = new Room(0.276, 0.858, '324', 2);
        let point8: Room = new Room(0.407, 0.824, '', 2);
        let point9: Room = new Room(0.407, 0.859, '323', 2);
        let point10: Room = new Room(0.541, 0.861, '322', 2);
        let point11: Room = new Room(0.535, 0.822, '', 2);
        let point12: Room = new Room(0.662, 0.821, '', 2);
        let point13: Room = new Room(0.662, 0.861, '321', 2);
        let point14: Room = new Room(0.797, 0.948, '320 A', 2);
        let point15: Room = new Room(0.790, 0.906, '', 2);
        let point16: Room = new Room(0.830, 0.902, '320', 2);
        let point17: Room = new Room(0.832, 0.782, '319', 2);
        let point18: Room = new Room(0.786, 0.784, '', 2);
        let point19: Room = new Room(0.792, 0.658, '', 2);
        let point20: Room = new Room(0.833, 0.658, '318', 2);
        let point21: Room = new Room(0.793, 0.529, '', 2);
        let point22: Room = new Room(0.834, 0.525, '317', 2);
        let point23: Room = new Room(0.793, 0.399, '', 2);
        let point24: Room = new Room(0.830, 0.396, '316', 2);
        let point25: Room = new Room(0.830, 0.247, '315', 2);
        let point26: Room = new Room(0.793, 0.250, '', 2);
        let point27: Room = new Room(0.804, 0.130, '314', 2);
        let point28: Room = new Room(0.690, 0.206, '312', 2);
        let point29: Room = new Room(0.719, 0.232, '', 2);
        let point30: Room = new Room(0.616, 0.287, '311', 2);
        let point31: Room = new Room(0.630, 0.328, '', 2);
        let point33: Room = new Room(0.566, 0.402, '', 2);
        let point35: Room = new Room(0.502, 0.412, '', 2);
        let point36: Room = new Room(0.417, 0.406, '', 2);
        let point39: Room = new Room(0.345, 0.485, '', 2);
        let point40: Room = new Room(0.345, 0.545, '', 2);
        let point41: Room = new Room(0.310, 0.531, '305', 2);
        let point43: Room = new Room(0.263, 0.655, '304', 2);
        let point44: Room = new Room(0.345, 0.644, '', 2);
        let point45: Room = new Room(0.313, 0.667, '', 2);
        let point46: Room = new Room(0.566, 0.642, '', 2);
        let rooms: Room[] = [];
